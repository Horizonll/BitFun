//! Provider-neutral bot support for Remote Connect.
//!
...
pub async fn read_workspace_file(
    ...
    let content = super::read_remote_workspace_file(raw_path, max_size, workspace_root)
        .await
