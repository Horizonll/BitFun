...
Scope: this guide applies to `src/crates/product-capabilities`.

`bitfun-product-capabilities` owns product capability pack assembly facts: which
runtime services, tool provider group ids, and harness provider descriptors a
product capability selects. It does not own concrete runtime execution.
