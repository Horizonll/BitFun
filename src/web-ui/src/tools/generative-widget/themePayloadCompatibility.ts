const WIDGET_THEME_COMPAT_ALIAS_FALLBACKS = {
  ...
  '--color-overlay-white-02': '--color-overlay-white-04',
  '--color-overlay-white-03': '--color-overlay-white-04',
  '--color-overlay-white-05': '--color-overlay-white-08',
  '--color-overlay-white-06': '--color-overlay-white-08',
  '--color-overlay-white-10': '--color-overlay-white-12',
  '--color-overlay-black-06': '--color-overlay-black-08',
  '--color-overlay-black-10': '--color-overlay-black-12',
  '--color-overlay-black-25': '--color-overlay-black-30',
